...
var AMMO_ITEM = preload("res://Scenes/Ammo/AmmoItem.tscn")

var READY_TRES = preload("res://Scenes/Ammo/ammo_item_ready.tres")
var RELOAD_TRES = preload("res://Scenes/Ammo/ammo_item_reload.tres")
